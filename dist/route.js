...
router.get('/me', isAuthenticated_1.isAuthenticated, new DetailUserController_1.DetailsUserController().handle);
...
router.get('/order', new ListOrderController_1.ListOrderController().handle);
router.get('/order/details', new DetailOrderController_1.DetailOrderController().handle);
